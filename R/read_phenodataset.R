...
#' @param ukb_codings The UKB codings dictionary. This should be a data frame where all columns are of type \code{character}. By
...
#SETUP
  ...
  ukb_df <- data.table::fread(
    path,
    select = data_dict$colheaders_raw, # selected cols
    colClasses = c('character'),
