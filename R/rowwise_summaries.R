...
#'
#'   # data dictionary generated by make_data_dict()
#'   data_dict = data_dict,
#'
#'   # to summarise by FieldID
#'   grouping_col = "Field_FieldID",
#'
#'   # ...and only summarise numerical data
...
summarise_rowise <- function(ukb_pheno,
  ...
  assertthat::assert_that(
    is.character(selected_col_groups),
    msg = "Error! `selected_col_groups` must be a character vector"
  )
