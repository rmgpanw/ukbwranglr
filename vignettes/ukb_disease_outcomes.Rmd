...
test <- get_self_report_non_cancer_diagnoses(
  dummy_ukb_data,
  dummy_data_dict,
  ukb_codings
)
...
test <- get_hes_icd10_diagnoses(
  dummy_ukb_data,
  dummy_data_dict,
  ukb_codings
)

hm <- get_diagnoses_set_index_code_date_cols(get_diagnoses_df = hes_icd10_diagnoses, index_col = "f41270", code_col = "f41270_value", date_col = "f41280_value", code_type = "ICD10"
)
```
