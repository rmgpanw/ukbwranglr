...
test_that("`assert_all_df_cols_are_type_character()` raises error appropriately", {
  ...
  expect_error(
    assert_all_df_cols_are_type_character(not_acceptable_df, "not_acceptable_df"),
